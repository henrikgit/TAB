...
\newenvironment{specialnote}{\ignorespaces\begin{center}\begin{minipage}{0.75\linewidth}\sffamily\singlespacing}{\end{minipage}\end{center}\ignorespacesafterend}
%\newenvironment{specialnote}{\ignorespaces\par\centering\begin{minipage}{0.8\linewidth}\singlespacing\small\sffamily}{\end{minipage}\parfillskip{1em}\par\ignorespacesafterend}
...
\newcommand{\blattname}[1]{\emph{#1}\xspace}
\newcommand{\system}[1]{\emph{#1}\xspace}
\newcommand{\begriff}[1]{\textit{#1}\xspace}
%\newcommand{\begriff}[1]{\emph{#1}}
\newcommand{\betont}[1]{\emph{#1}\xspace}
