...
%\newenvironment{specialnote}[1]{\begin{center}\begin{minipage}{0.8\linewidth}\centering\small\sffamily{#1}}{\end{minipage}\end{center}}
\newenvironment{specialnote}[1]{\begin{center}\begin{minipage}{0.8\linewidth}\singlespacing\small\sffamily{#1}}{\end{minipage}\end{center}}
