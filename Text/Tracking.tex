...
For the day-to-day stuff I created the overarching class/field\footnote{To this day, I am not 100\,\% sure if either \emph{class} or \emph{field} is the better term for this structure item in the hierarchy.} named \sterm{Daily}.
