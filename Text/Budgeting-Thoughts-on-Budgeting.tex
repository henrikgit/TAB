...
All that may be discussed further and deeper, but ultimately you need to decide which path you take:
\begin{itemize}
...
\end{itemize}
\begin{specialnote}
	But however you decide, never changes dates for tracking.
\end{specialnote}
