...
At this stage, something like \sterm{loose thoughts for future features and enhancements} is be a more appropriate phrase.
...
\begin{itemize}
	...
	Lots and lots of formulas would have to be changed, as well as sheets like \sheetname{Budget}.
	\item Notes on how to create a backup\ldots and then to re-import the old tracking sheets?
	\item Structuring the whole \programmcode{.ods}-file in a way that all the sheetnames are replicated in \sheetname{Tracker} and then work like hyperlinks to link to the relevant sheet.
