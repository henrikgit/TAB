...
\begin{itemize}
	\item To read about how to work with dates in reality differing from the thought up dates in \tfn, go to \autoref{subsubsec:thoughts-different-dates}, \autopageref{subsubsec:thoughts-different-dates}.
	...
	\item You should not add budget items retroactively: 	\autoref{subsubsec:thoughts-delayed-budgeting}, \autopageref{subsubsec:thoughts-delayed-budgeting}.
\end{itemize}
