...
If you clicked on one, you can go back to the old location by clicking on the big left arrow-button or using the keyboard shortcut \keystroke{Alt}+\keystroke{\( \leftarrow \)}  in Adobe Reader.
