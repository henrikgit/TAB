...
The term \sterm{household} was mentioned at the beginning of \autoref{subsec:first-things-first} and stands for whom this file is most likely the most useful: persons, as opposed to (little) businesses.\footnote{But that should not deter you from using the file!}
