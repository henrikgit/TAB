...
First and foremost, the spreadsheet file \begriff{Finances-2019.ods} is intended to help you to track and budget your finances, or rather, cash.
The file is free and can be viewed as a tool that you can use for managing your household's books and savings.\footnote{From here on forth, whenever \begriff{file} or \begriff{\tfn} is mentioned or referenced, it shall be interpreted synonymous with \begriff{Finances-2019.ods} or whichever year is written down.}
It is, in a sense, all about book-keeping or rather, \begriff{tracking} in a sheet such as the one displayed \autoref{fig:introduction-tracking-sheet-screenshot}.
...
The term \begriff{household} was mentioned at the beginning of \autoref{subsec:first-things-first} and stands for whom this file was conceptualized: persons, as opposed to (little) businesses.
...
\begin{itemize}
	...
	\item The Drift:\\
	An inevitable occurence when using the file is what I like to call \begriff{the drift}.
	...
	To offset the drift, enter values in the \begriff{drift cells} in the \sheetname{Overview} sheet.
...
\begin{itemize}
	...
	\item Given that \tfn is an actual \programmcode{.ods}-file, this means that one does work on/in it while sitting in front of a computer/laptop.
...
As stated on \autopageref{foreword}, the gray boxes indicate hyperlinks and can be clicked or touched.
