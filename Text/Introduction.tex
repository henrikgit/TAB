...
\begin{itemize}
	...
	To offset the drift, enter values in the \sterm{drift cells} in the \sheetname{Overview} sheet.
...
I now track: my cash spending\footnote{I should note that I lump my cash spending and payments via some kinds of electronic method together.}, all other liabilities that represent cash outflows, my savings, my interests from these savings and other kinds of assets.
