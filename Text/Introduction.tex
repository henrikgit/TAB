...
However you may use whatever software you want.\footnote{About Excel: I do not own Excel and therefor am not going to port it to Excel at the moment. You can find more on that topic in \autoref{subsec:excel}, p.~\pageref{subsec:excel}.}
...
\begin{itemize}
	...
	As mentioned before, more on that topic in \fullref{subsec:excel}, p.~\pageref{subsec:excel}.}
...
More on that topic is mentioned in \fullref{subsec:security}, p.~\pageref{subsec:security}.
...
If you are interested in that, you can jump to \fullref{sec:feedback} on p.~\pageref{sec:feedback}.
