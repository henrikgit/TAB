...
It is to be understood as a tool for managing your household's books and savings.\footnote{From here on forth, whenever \begriff{file} or \begriff{\tfn} is mentioned or referenced, it shall be interpreted synonymous with \begriff{Finances-2019.ods} or whichever year is written down.}
...
\tfn was created in LibreOffice's spreadsheet program named \begriff{Calc}, hence I strongly suggest you use it when working with this file.
...
\begin{itemize}
	...
	More on that topic in \fullref{subsec:excel}, p.~\pageref{subsec:excel}.}
...
In case you intend to use \tfn for managing finances of more than one person, I suppose all persons involved have to understand the points outlined above.
...
More on that topic is mentioned in \fullref{subsubsec:security}, p.~\pageref{subsubsec:security}.
