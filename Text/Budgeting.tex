...
\begin{itemize}
	\item Put \programmcode{Yes} if the time period of the budgeted expense is \emph{longer} than 1 month.
...
\end{itemize}
Again, please do read \autoref{subsec:examples-budgeting-expenses} starting on \autopageref{subsec:examples-budgeting-expenses} for more clarification.\todo{ausarbeiten}
...
spend it on the budgeted expense, which has now been fully budgeted.\todo{ausarbeiten}
...
budgeted amount is to be summed up in the end month or not.\todo{ausarbeiten}
