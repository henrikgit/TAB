...
\begin{itemize}
	...
	By the way, if you are using Windows and Adobe Reader for reading PDF-files, you can quickly jump to any page with the keyboard shortcut \keystroke{Ctrl}+\keystroke{N}.
...
\begin{itemize}
	...
	\item The navigator (reachable via \keystroke{F11}) enables you to navigate arguably fast between the sheets if you do not use keyboard shortcuts.
	...
	For example, if you are in a block of values with no gaps and you would like to select the current cell all the cells to the right in this block of the current cell, use the shortcut \keystroke{Shift} + \keystroke{Ctrl} + \keystroke{\( \rightarrow \)}.
\end{itemize}
