...
\begin{itemize}
	...
	\begin{enumerate}
		...
		If you copied the content in a spreadsheet file, Calc will show a dialog window named \sterm{Paste Special}.\footnote{If you are in fact working in Excel, use \keystroke{Ctrl}+\keystroke{Alt}+\keystroke{V}.}
