...
\begin{itemize}
	...
	\item However, pasting can be done in multiple ways:
	\begin{enumerate}
		\item The well-known way: \keystroke{Ctrl}+\keystroke{V}.
		This keeps the content in cache and you can paste it again.
		\item The other way is pressing \keystroke{\( \hookleftarrow \)} (Enter).
		This does not keep the content in cache.
		\item The best way: \keystroke{Ctrl}+\keystroke{\( \Uparrow \) (Shift)}+\keystroke{V}.
		This will show a dialog first, in which you can select the intended attributes of the paste action.
		With Enter or clicking on \keystroke{Ok}, the copied content gets pasted to the currently marked cell.
	\end{enumerate}
