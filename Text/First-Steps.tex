...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \keystroke{\( \hookleftarrow \)}: simple and deleting cache. Simply press the the Enter key.
		This does not keep the content in the memory cache.
		\item \keystroke{Ctrl}+\keystroke{Shift}+\keystroke{V}: the ``richest'' way.
		If you copied the content in a spreadsheet file, Calc will show a dialog window named \sterm{Paste Special}.\footnote{If you are working with Excel, use \keystroke{Ctrl}+\keystroke{Alt}+\keystroke{V}.}
...
I regard the last point as inherent and will not provide a fleshed-out section for that item, but as you read through the chapters on tracking and budgeting, you will definitely learn how to use \tfn's ``tools'' to improve.