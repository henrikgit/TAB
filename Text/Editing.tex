...
For removing a tracking category or a whole section, I believe there is no extra section necessary and I hope it is sufficient to point you \fullref{subsubsec:adding-a-tracking-category-section}.
...
For the sake of brevity,  the formulas in the sheets 	\sheetname{BudgetEXPItems} and \sheetname{BudgetINCItems} will not be explained in full.
...
Finally, I strongly suggest you do not edit any formulas.
